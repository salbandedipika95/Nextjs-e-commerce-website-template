...
const Signin = () => {
  return (
    <>
      <Breadcrumb title={"Account Login"} pages={["Account Login"]} />
      <section className="overflow-hidden py-20 bg-white">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-gray-2 shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div>
              <form>
                <div className="flex flex-col gap-4.5 mb-5">
                  <button className="flex text-dark font-medium justify-center items-center gap-3.5 rounded-lg border border-gray-3 bg-white p-3 ease-out duration-200 hover:bg-[#f44242] hover:text-white">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                ...
                <span className="relative z-1 block font-medium text-center my-6">
                  <span className="block absolute -z-1 left-0 top-1/2 h-px w-full bg-gray-3"></span>
                  <span className="inline-block px-3 text-dark text-lg">
                    OR
                  </span>
                </span>
                <div className="mb-5">
                  <label htmlFor="email text-dark" className="block mb-2.5">
                  ...
                  <input
                    ...
                    className="rounded-lg border border-gray-3 bg-white placeholder:text-dark-5 w-full py-3 px-5 outline-none duration-200 focus:border-transparent  focus:ring-2 focus:ring-dark-5"
                  />
                </div>

                <div className="mb-5">
                  <label htmlFor="password text-dark" className="block mb-2.5">
                    Password
                  </label>
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-white bg-[#E53E3E] py-3 px-6 rounded-lg ease-out duration-200 hover:bg-[#f44242] mt-7.5"
                >
                  Login Account
                </button>
                ...
                <a
                  href="#"
                  className="block text-left text-dark mt-4.5 ease-out duration-200 hover:text-[#f44242]"
                >
                  Lost your password?
                </a>
                ...
                <p className="text-center mt-6">
                  ...
                  <Link
                    href="/signup"
                    className="text-dark ease-out duration-200 hover:text-[#f44242] pl-2"
                  >
                    Sign Up Now!
                  </Link>
                </p>
