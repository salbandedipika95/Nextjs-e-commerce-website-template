...
const Signup = () => {
  return (
    <>
      <Breadcrumb title={"Account Register"} pages={["Account Register"]} />
        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-gray-2 shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div className="flex flex-col gap-4.5">
              <button className="flex justify-center items-center gap-3.5 rounded-lg border border-gray-3 bg-white p-3 ease-out duration-200 hover:bg-[#f44242] hover:text-white">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
            ...
            <span className="relative z-1 block font-medium text-center my-6">
              ...
              <span className="inline-block px-3 text-dark text-lg">OR</span>
            </span>
            ...
            <div className="mt-5.5">
              <form>
                ...
                <p className="text-left text-dark mt-6">
                  Already have an account?
                  <Link
                    href="/signin"
                    className="text-[#E53E3E] ease-out duration-200 hover:text-[#f44242] pl-2"
                  >
                   Log in
                  </Link>
                </p>
