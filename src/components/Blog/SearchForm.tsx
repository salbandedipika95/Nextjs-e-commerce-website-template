...
const SearchForm = () => {
  return (
    <div className=" bg-white border border-gray-3 rounded-xl">
        ...
        <form>
          <div className="relative">
            <input
              ...
              className="w-full rounded-md border border-gray-3 py-3 pl-5 pr-13 outline-none ease-out duration-200 placeholder:text-dark-5 focus:border-transparent  focus:ring-2 focus:ring-dark-5"
            />
