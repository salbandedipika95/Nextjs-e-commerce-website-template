...
const SingleItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-7 px-7.5">
<div className="min-w-[120px] ">
        <button
          onClick={() => handleRemoveFromCart()}
          aria-label="button for remove product from cart"
          className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-gray-2 border border-gray-3 text-dark ease-out duration-200 hover:bg-red-light-6 hover:border-red-light-4 hover:text-[#E53E3E]"
        >
          <svg
