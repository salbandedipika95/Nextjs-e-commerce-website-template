...
const Cart = () => {
  ...
  return (
    <>
      ...
      <section>
        <Breadcrumb title={"Cart Page"} pages={["Cart Page"]} />
      </section>
      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-white">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div className="bg-gray-2 rounded-[10px] shadow-1">
              <div className="w-full overflow-x-auto">
                <div className="min-w-[1170px]">
                  {/* <!-- table header --> */}
                  <div className="flex items-center py-5.5 px-7.5">
                    <div className="min-w-[120px]">
                      {/* <p className="text-dark text-left uppercase">Action</p> */}
                    </div>
                    <div className="min-w-[400px]">
                      <p className="text-dark uppercase ml-5">Products</p>
                    </div>

                    <div className="min-w-[180px] ">
                      <p className="text-dark uppercase">Price</p>
                    </div>

                    <div className="min-w-[275px]">
                      <p className="text-dark uppercase">Quantity</p>
                    </div>

                    <div className="min-w-[100px] text-right">
                      <p className="text-dark uppercase">Subtotal</p>
                    </div>
                  </div>
