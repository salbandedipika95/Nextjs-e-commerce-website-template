          ...
          <form>
            <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-11">
              ...
              <div className="lg:max-w-[670px] w-full">
                ...
                {/* <!-- others note box --> */}
                <div className="bg-gray-2 shadow-1 rounded-[10px] p-4 sm:p-8.5 mt-7.5">
                  <div>
                    ...
                    <textarea
                      ...
                      className="rounded-md border border-gray-3 bg-white placeholder:text-dark-5 w-full p-5 outline-none duration-200 focus:border-transparent  focus:ring-2 focus:ring-gray-4"
                    ></textarea>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-[455px] w-full">
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-white bg-[#E53E3E] py-3 px-6 rounded-md ease-out duration-200 hover:bg-[#f34242] mt-7.5"
                >
                  Process to Checkout
                </button>
              </div>
