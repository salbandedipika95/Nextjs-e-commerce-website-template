  ...
  return (
    <div className="bg-white shadow-1 rounded-[10px]">
      <div
        ...
        className={`cursor-pointer bg-gray-2 flex items-center gap-0.5 py-5 px-5.5 ${
      ...
      >
        <p className="text-custom-sm mb-6 text-dark">
        ...
        <button
          type="submit"
          className="inline-flex font-medium text-white bg-[#E53E3E] py-3 px-10.5 rounded-md ease-out duration-200 hover:bg-[#ef4141]"
        >
          Login
        </button>
      </div>
