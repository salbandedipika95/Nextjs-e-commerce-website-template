            ...
            <div className="xl:max-w-[370px] w-full bg-white rounded-xl shadow-1">
              ...
              <div className="px-4 sm:px-7.5">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="flex items-center ">Weekend Closed</p>
                </div>
              </div>
            </div>
            ...
            <div className="xl:max-w-[770px] w-full bg-white rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
              ...
              <form>
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  ...
                  <div className="w-full">
                    <label htmlFor="emiladdress" className="block mb-2.5">
                      Email address
                    </label>
                ...
                <button
                  type="submit"
                  className="inline-flex font-medium text-white bg-[#E53E3E] py-3 px-7 rounded-md ease-out duration-200 hover:bg-[#f84444]"
                >
                  Send Message
                </button>
              </form>
