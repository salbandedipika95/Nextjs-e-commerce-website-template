        ...
        >
          ...
          <div>
            <form>
              <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                <div className="w-full">
                  ...
                  <input
                    ...
                    className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent  focus:ring-2 focus:ring-gray-5"
                  />
                </div>
              ...
              <button
                type="submit"
                className="inline-flex font-medium text-white bg-[#E53E3E] py-3 px-7 rounded-md ease-out duration-200 hover:bg-[#f54242]"
              >
                Save Changes
              </button>
            </form>
