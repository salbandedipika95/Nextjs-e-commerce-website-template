    ...
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className="inline-flex text-white text-xs hover:text-white uppercase bg-[#E53E3E] border border-gray-3 py-2.5 px-6 rounded-md ease-out duration-200 hover:bg-[#f84444] hover:border-gray-3"
        >
          Add to Cart
        </button>
      </div>
