...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden bg-gray-2">
      <div className="max-w-[1170px] w-full mx-auto bg-white rounded-md py-6 px-14 mt-16 ">
        <div className="flex flex-wrap justify-between items-center gap-7.5 xl:gap-12.5 ">
          {featureData.map((item, key) => (
            <div className="flex items-center gap-4" key={key}>
              <Image src={item.img} alt="icons" width={30} height={30} />
              <div>
      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        {/* <!-- footer menu start --> */}
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-4 xl:justify-between pt-10 xl:pt-14 pb-10 xl:pb-12">
          <div className="max-w-[250px] w-full">
            <h2 className="mb-4 text-base font-medium text-dark">
              About Store
            </h2>
            ...
            <ul className="flex flex-col gap-2">
              <li className="mb-2">
                <a href="#" className="flex items-center gap-4.5">
                  ...
                  <div>
                    <p className="text-sm">Have Question? Call Us 24/7</p>
                    <p className="text-[#E53E3E] text-lg font-semibold">
                      +258 3692 2569
                    </p>
                  </div>
                </a>
              ...
              <li>
                <a href="#" className="flex items-center text-sm gap-2">
                  Saturday:{" "}
                  <span className="font-semibold text-sm text-dark">
                    8:00am - 6:00pm
                  </span>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-4 text-base font-medium text-dark">Our Stores</h2>

            <ul className="flex flex-col gap-2">
              <li>
                <a
                  className="ease-out text-sm duration-200 hover:text-blue"
                  href="#"
                >
                  New York
                </a>
          ...
          <div className="w-full sm:w-auto">
            ...
            <p className="text-sm mb-5">
              Subscribe to mailing list to receive updates <br /> one new
            ...
            <div className="relative  w-full mb-5">
              <input
                ...
                autoComplete="off"
                className="custom-search text-xs w-full rounded-xl bg-gray-1  border border-gray-3 py-4 pl-6 pr-20 outline-none ease-in duration-200"
              />
      ...
      {/* <!-- footer bottom start --> */}
      <div className="py-5 xl:py-6 border-t border-gray-3">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <div className="flex flex-wrap items-center gap-4">
              <p className="font-medium text-dark">Payment System:</p>
            ...
            <p className="text-dark font-medium">
              Copyright {year} &copy; Roiser. All rights reserved.
            </p>
          </div>
        </div>
      </div>
